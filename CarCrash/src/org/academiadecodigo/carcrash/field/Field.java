...
public final class Field {
    ...
    public static void draw(Car[] cars) {
        ...
        for (Car c : cars) {
            ...
            if (!c.isCrashed()) {
                screenWriter.drawString(c.getPos().getCol(), c.getPos().getRow(), c.getName());
            } else {
                screen.putString(c.getPos().getCol(), c.getPos().getRow(), c.getName(), Terminal.Color.WHITE, Terminal.Color.RED, ScreenCharacterStyle.Blinking);
            }
